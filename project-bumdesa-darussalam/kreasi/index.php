    ...
    <!-- <section class="ftco-intro">
    	<div class="container-wrap">
    		<div class="wrap d-md-flex align-items-xl-end">
	    		...
	    		<div class="book p-4">
	    			<h3>INGIN PESAN BUBUK KOPI UNTUK BULAN DEPAN? BISA!</h3>
	    			<form action="#" class="appointment-form">
	    				...
	    				<div class="d-md-flex">
		            		...
		            		<input type="text" class="form-control appointment_date" placeholder="Isi Tanggal">
	            		</div>
		    				</div>
		    				<div class="form-group ml-md-4">
		    					<div class="input-wrap">
		    				...
		    				<div class="form-group ml-md-4">
		    					<input type="text" class="form-control" placeholder="No. WA / HP">
		    				</div>
	    				</div>
	    				<div class="d-md-flex">
	    					<div class="form-group">
		              <textarea name="" id="" cols="30" rows="2" class="form-control" placeholder="Isi Pesan Untuk Penjual"></textarea>
		            </div>
		            <div class="form-group ml-md-4">
		              <input type="submit" value="Kirim Pesanan!" class="btn btn-white py-3 px-4">
		            </div>
	    				</div>
	    			</form>
	    		</div>
